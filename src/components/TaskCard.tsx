  ...
  return (
    <div className="relative overflow-hidden rounded-lg">
      ...
      <div className="absolute inset-y-0 right-0 flex items-stretch">
        <button
          onClick={handleUndo}
          className="w-15 flex items-center justify-center bg-gray-700 text-white text-xs font-medium px-3"
        >
          Undo
        </button>
        <button
          onClick={handleConfirmDelete}
          className="w-15 flex items-center justify-center bg-red-600 text-white text-xs font-medium px-3"
        >
          Delete
        </button>
      </div>
      ...
      <div
        ...
        className={`relative flex items-start gap-3 p-3 border transition-transform ${
          isDone
            ? 'bg-gray-900/50 border-gray-800 opacity-60'
            : 'bg-gray-900 border-gray-800 hover:border-gray-700'
        } ${swiped ? '' : 'rounded-lg'}`}
        style={{ transition: swiped ? 'none' : 'transform 0.2s ease-out' }}
      >
        <button
