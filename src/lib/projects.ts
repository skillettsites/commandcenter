...
export const projects: Project[] = [
  ...
  { id: 'carcostcheck', name: 'CarCostCheck', url: 'https://carcostcheck.co.uk', color: '#3B82F6', gaPropertyId: '527762233', gscSiteUrl: 'sc-domain:carcostcheck.co.uk' },
  { id: 'postcodecheck', name: 'PostcodeCheck', url: 'https://postcodecheck.co.uk', color: '#10B981', gaPropertyId: '527604139', gscSiteUrl: 'sc-domain:postcodecheck.co.uk' },
  ...
  { id: 'helpafterloss', name: 'HelpAfterLoss', url: 'https://helpafterloss.co.uk', color: '#EC4899', gaPropertyId: '528390174', gscSiteUrl: 'https://helpafterloss.co.uk/' },
  { id: 'helpafterlife', name: 'HelpAfterLife', url: 'https://helpafterlife.com', color: '#D946EF', gscSiteUrl: 'sc-domain:helpafterlife.com' },
  { id: 'aibetfinder', name: 'AI Bet Finder', url: 'https://aibetfinder.com', color: '#F43F5E', gscSiteUrl: 'sc-domain:aibetfinder.com' },
  { id: 'bestlondontours', name: 'BestLondonTours', url: 'https://bestlondontours.co.uk', color: '#E11D48', gscSiteUrl: 'sc-domain:bestlondontours.co.uk' },
