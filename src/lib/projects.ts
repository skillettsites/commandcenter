...
export const projects: Project[] = [
  ...
  { id: 'helpafterloss', name: 'HelpAfterLoss', url: 'https://helpafterloss.co.uk', color: '#EC4899', gaPropertyId: '528390174', gscSiteUrl: 'sc-domain:helpafterloss.co.uk' },
  { id: 'helpafterlife', name: 'HelpAfterLife', url: 'https://helpafterlife.com', color: '#D946EF' },
  { id: 'aibetfinder', name: 'AI Bet Finder', url: 'https://aibetfinder.com', color: '#F43F5E' },
  { id: 'bestlondontours', name: 'BestLondonTours', url: 'https://bestlondontours.co.uk', color: '#E11D48' },
